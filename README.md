...
A Python-based command-line Todo List application to help you manage your tasks efficiently. Features include task creation, editing, deletion, filtering, reminders, and exporting tasks to CSV or PDF formats. With a modular design, the application is easy to maintain and extend.
...
Prerequisites
	...
	•	Python 3.6 or higher: Ensure that Python is installed on your system. You can download it from the official website.
